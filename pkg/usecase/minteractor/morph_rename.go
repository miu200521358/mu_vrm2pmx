...
var morphRenameMappings = []morphRenameMappingRow{
	...
	{Name: "目光なし", Panel: model.MORPH_PANEL_EYE_UPPER_LEFT, Sources: []string{"目光なし"}},
	{Name: "目光なし右", Panel: model.MORPH_PANEL_EYE_UPPER_LEFT, Sources: []string{"目光なし右"}},
	{Name: "目光なし左", Panel: model.MORPH_PANEL_EYE_UPPER_LEFT, Sources: []string{"目光なし左"}},
